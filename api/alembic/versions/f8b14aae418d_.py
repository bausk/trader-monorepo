...
def upgrade():
    ...
    op.add_column('sources', sa.Column('typename', sa.Enum('bigquery', 'kuna', 'cryptowatch', name='sourcetypesenum'), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('sources', sa.Column('type', sa.VARCHAR(), autoincrement=False, nullable=True))
